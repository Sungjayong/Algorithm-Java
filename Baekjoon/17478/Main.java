...
class Main {
    public static void main(String[] args) {
       ...
       printTalk(n, sb); // 재귀 start!
    }

    public static void printTalk(int n, StringBuilder sb) {
        String sbb = "____";
        ...
        printTalk(n-1, sb.append(sbb)); //____ 추가를 위해!
        sb.setLength(sb.length() - 4); // 라고 답변하였지로 돌아 왔을 때는 ____가 더 적어야 함.
        System.out.println(sb.toString() + "라고 답변하였지.");
    }
}
